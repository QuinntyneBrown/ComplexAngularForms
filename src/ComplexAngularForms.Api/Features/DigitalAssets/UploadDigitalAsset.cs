using ComplexAngularForms.Api.Helpers;
...
namespace ComplexAngularForms.Api.Features
{
    public class UploadDigitalAsset
    {
        ...
        {
            public IComplexAngularFormsDbContext _context { get; set; }
            public IHttpContextAccessor _httpContextAccessor { get; set; }
            public Handler(IComplexAngularFormsDbContext context, IHttpContextAccessor httpContextAccessor)
            {
                _context = context;
